    ...
    TestedBy: document.querySelector('input[name="tested by"]').value
      ...
      pdf.setFontSize(12);
      pdf.text('Testing Of Fire Vehicles FT-1/2/3/4/5', 95, subtitleY + 2, { align: 'center' });
  ...
  pdf.text('Doc No: HPCL MR/FRM/F&S/08200-01', textX, textY + 20);
...
const remarksText = '4.REMARKS';
const remarksX = 10; // Adjust x position as needed
const remarksY = 220; // Position below the Maintenance section
...
const totalPages = pdf.internal.getNumberOfPages();
  for (let i = 1; i <= totalPages; i++) {
      ...
      pdf.text(`Page ${i} of ${totalPages}`, pdf.internal.pageSize.width / 2, pdf.internal.pageSize.height - 10, { align: 'center' });
        ...
        pdf.save("FIRE_VEHICLE_Test_Report.pdf");
    });
});
